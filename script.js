...
// const findAndMoveElement = function (e) {
//         const findElement = document.body.querySelector('.block')
//         findElement.style.right = '10px'
//         if (e.keyCode === 39)
...
document.addEventListener("keydown", findAndMoveElement)
